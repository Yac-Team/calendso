          ...
          <div className="w-full mr-2 sm:w-9/12">
            <div className="p-4 py-6 -mx-4 bg-white border rounded-sm border-neutral-200 sm:mx-0 sm:px-8">
              <form onSubmit={updateEventTypeHandler} className="space-y-6">
                ...
                <hr />
                <div className="space-y-3">
                  {eventType.slug !== "async" && (
                    <>
                      <div className="block sm:flex">
                        <div className="min-w-48 sm:mb-0">
                          <label
                            htmlFor="location"
                            className="flex mt-2.5 text-sm font-medium text-neutral-700">
                          ...
                          {locations.length > 0 && (
                            <ul>
                              {locations.map((location) => (
                                <li
                                  key={location.type}
                                  className="py-1.5 px-2 mb-2 border rounded-sm shadow-sm border-neutral-300 text-gray-800">
